...
gulp.task('lint', function() {
    return gulp.src(['app/app.js', 'app/config.js', 'app/controllers/*.js', 'app/factories/*.js'])
        .pipe(jshint({ predef: [ 'app', 'Firebase' ] }))
...
// Copy all factories
gulp.task('copy-factories', function() {
    return gulp.src('app/factories/*.js')
        .pipe(concat('all.js'))
        .pipe(gulp.dest('dist/factories/'));
});
...
// Default Task
gulp.task('default', sequence(['clean'], ['lint', 'scripts', 'bootstrap-styles', 'bootstrap-scripts', 'stylus', 'pug', 'pug-index', 'pug-directives', 'copy-favicon', 'copy-main', 'copy-factories', 'copy-controllers', 'copy-directives', 'copy-fonts'], ['watch'], ['serve']));
