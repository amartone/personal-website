...
gulp.task('scripts', function() {
		return gulp.src(['app/scripts/wow.min.js', 'app/scripts/particles.js','app/scripts/app.js', 'app/scripts/matrix-text.js', 'app/scripts/demo.js', 'app/scripts/scrolltrigger.min.js'])
